...
function PackagesCreate() {
    ...
    // console.log(`setCourseDiscount`, courseDiscount);
    ...
    const handleCourseSubmit = async (formData) => {
        try {
            ...
            // console.log(`formData.discount_america`, formData.discount_america);
            ...
            <div className="space-y-8 p-6 bg-gray-50 min-h-screen">
                <div className="">
                    <div className="flex justify-start items-center gap-2 mb-8">
                        <button
                            onClick={() => navigate(`/${App_User}/packages`)}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                max={100}
                                                placeholder="مثال: 20"
                                                className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all hidden `}
                                            ...
                                            <input
                                                type="number"
                                                name="discount"
                                                min={courseDiscount || 20}
                                                max={courseDiscount || 20}
                                                value={courseDiscount || 20}
                                                placeholder="مثال: 20"
