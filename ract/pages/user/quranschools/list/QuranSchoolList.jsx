...
// api
import { userGetStudentEnrolledQuranSchools } from "../../../../api/user/authUser";
...
function QuranSchoolList() {
    ...
    const fetchCourses = async () => {
        try {
            ...
            const { data, error } = await userGetStudentEnrolledQuranSchools(
                userData?.id,
                currentPage
            );
        ...
        <>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-center">
                    ...
                    >
                        <span className="span">شاهد جميع الفصول</span>
