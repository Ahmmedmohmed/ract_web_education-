...
// api
import {
    publicGetCoursesIsLive,
    publicSearchCoursesIsLive,
    publicUpdateCourseVisibility,
    publicDeleteCourse,
...
function AdminCoursesIsLiveList() {
    ...
    const fetchCourses = async () => {
        try {
            ...
            const { data, error } = await publicGetCoursesIsLive(currentPage);
    ...
    const handleSearch = async () => {
        try {
            const { data, error } = await publicSearchCoursesIsLive(
                searchQuery,
                currentPage
            );
                                    ...
                                    <div className="flex flex-col md:flex-row p-4">
                                        <div
                                            ...
                                            onClick={() => {
                                                ...
                                                // ) {
                                                //     navigate(
                                                //         `/${App_Admin}/coursesislive/${course?.id}`
                                                //     );
                                                // }
                                            }}
                                        >
                                            ...
                                            <div className="flex justify-between items-start">
                                                ...
                                                <div className="flex space-x-2">
                                                    ...
                                                    {/* {userData?.id ===
                                                        course?.user?.id && ( */}
                                                    <Link
                                                        to={`/${App_Admin}/coursesislive/update/${course?.id}`}
                                                        className={`p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md`}
                                                        title="تعديل الدورة"
                                                    >
                                                        <Edit size={18} />
...
export default AdminCoursesIsLiveList;
