...
// api
import { publicCreateQuranCircle } from "../../../../api/public/authPublic";
...
function QuranCirclesCreate() {
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            sectionData.append("present_roses", formData.present_roses || "");
            sectionData.append("past_roses", formData.past_roses || "");
            ...
            const { data, error } = await publicCreateQuranCircle(sectionData);
            ...
            if (error) {
                ...
                Toast("success", "تم إنشاء الورد بنجاح");
                navigate(
            ...
            Toast("error", "حدث خطأ أثناء إنشاء الورد");
            setIsLoading(false);
        } finally {
            setIsLoading(false);
        }
...
export default QuranCirclesCreate;
