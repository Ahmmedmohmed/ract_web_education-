...
// api
import {
    publicDeleteFileAndLibrary,
    publicGetFileAndLibraryById,
    publicUpdateFileAndLibrary,
...
function FileAndLibraryUpdate() {
    const { quranpathId, chapterinquranId, fileandlibraryId } = useParams();
    ...
    useEffect(() => {
        const fetchClassRoom = async () => {
            try {
                const { data, error } = await publicGetFileAndLibraryById(
                    fileandlibraryId
                );
    ...
    const handleUpdate = async (formData) => {
        try {
            ...
            const { data, error } = await publicUpdateFileAndLibrary(
                fileandlibraryId,
                updateData
            );
    ...
    const handleDelete = async () => {
        try {
            ...
            const { error } = await publicDeleteFileAndLibrary(
                fileandlibraryId
            );
...
export default FileAndLibraryUpdate;
