...
import { publicCreateFamousSaying } from "../../../../api/public/authPublic";
...
function FamousSayingsCreate() {
    ...
    const handleCourseSubmit = async (formData) => {
        try {
            ...
            const { data, error } = await publicCreateFamousSaying(courseData);
            ...
            if (error) {
                ...
                Toast("success", "تم إنشاء الاقوال بنجاح");
                navigate(`/${App_Admin}/famoussayings`);
            }
        } catch (error) {
            console.error("Error creating course:", error);
            Toast("error", "حدث خطأ أثناء إنشاء الاقوال");
        } finally {
            setIsLoading(false);
        }
    };
                        ...
                        >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    name="description"
                                    rows={4}
                                    placeholder="مثال: أفضلقول في التحصيلي رياضيات"
...
export default FamousSayingsCreate;
