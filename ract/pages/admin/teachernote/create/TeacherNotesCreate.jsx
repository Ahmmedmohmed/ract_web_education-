...
// api
import { publicCreateTeacherNote } from "../../../../api/public/authPublic";
...
function TeacherNotesCreate() {
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            const { data, error } = await publicCreateTeacherNote(sectionData);
...
export default TeacherNotesCreate;
