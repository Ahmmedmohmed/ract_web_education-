...
// api
import { publicCreatePresenceAndAbsence } from "../../../../api/public/authPublic";
...
function PresenceAndAbsencesCreate() {
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            sectionData.append("session_type", formData.session_type || "");
            ...
            const { data, error } = await publicCreatePresenceAndAbsence(
                sectionData
            );
            ...
            if (error) {
                ...
                Toast("success", "تم إنشاء جلسة حضور بنجاح");
                navigate(
            ...
            Toast("error", "حدث خطأ أثناء إنشاء جلسة حضور");
            setIsLoading(false);
        } finally {
            setIsLoading(false);
        }
...
export default PresenceAndAbsencesCreate;
