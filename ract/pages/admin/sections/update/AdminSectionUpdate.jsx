...
function AdminSectionUpdate() {
    ...
    useEffect(() => {
        const fetchSection = async () => {
            try {
                const { data, error } = await adminGetSectionById(sectionId);
    ...
    const handleUpdate = async (formData) => {
        try {
            ...
            const { data, error } = await adminUpdateSection(
                sectionId,
                updateData
            );
    ...
    const handleDelete = async () => {
        try {
            ...
            const { error } = await adminDeleteSection(sectionId);
