...
function AdminSectionsCreate() {
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            // sectionData.append("scheduleTime", formData.scheduleTime);
            ...
            const { data, error } = await adminCreateSection(sectionData);
            ...
            <div className="space-y-8 p-6 bg-gray-50 min-h-screen">
                <div className="">
                    <div className="flex justify-start items-center gap-2 mb-8">
                        <button
                            onClick={() => navigate(`/${App_Admin}/sections`)}
...
export default AdminSectionsCreate;
