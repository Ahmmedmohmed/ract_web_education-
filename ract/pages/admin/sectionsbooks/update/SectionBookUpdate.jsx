...
import {
    ...
    adminGetCategories,
    adminGetSectionBookById,
    adminUpdateSectionBook,
...
function SectionBookUpdate() {
    ...
    useEffect(() => {
        const fetchSection = async () => {
            try {
                const { data, error } = await adminGetSectionBookById(
                    sectionId
                );
    ...
    const handleUpdate = async (formData) => {
        try {
            ...
            const { data, error } = await adminUpdateSectionBook(
                sectionId,
                updateData
            );
    ...
    const handleDelete = async () => {
        try {
            ...
            const { error } = await adminDeleteSectionBook(sectionId);
...
export default SectionBookUpdate;
