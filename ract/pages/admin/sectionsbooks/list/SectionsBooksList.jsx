...
import {
    adminGetCategories,
    adminGetSections,
    adminDeleteSectionBook,
    adminUpdateSectionBookVisibility,
    adminGetSectionsBooksAdmin,
...
function SectionsBooksList() {
    ...
    const handleVisibilityChange = async (sectionId, newVisibility) => {
        ...
        try {
            const { data, error } = await adminUpdateSectionBookVisibility(
                sectionId,
                newVisibility
            );
    ...
    const confirmDelete = async () => {
        try {
            const { error } = await adminDeleteSectionBook(
        ...
        <>
            <div className="space-y-6 bg-gray-50 min-h-screen">
                <div className="flex justify-between items-center flex-wrap mb-8">
                    ...
                    <button
                        onClick={() =>
                            navigate(`/${App_Admin}/sectionsbooks/create`)
                        }
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center justify-end gap-3">
                                                        ...
                                                        <Link
                                                            to={`/${App_Admin}/sectionsbooks/update/${section?.id}`}
