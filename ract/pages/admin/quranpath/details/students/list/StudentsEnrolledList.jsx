...
// api
import { publicGetEnrollmentStuentQuranPathById } from "../../../../../../api/public/authPublic";
        ...
        <>
            <div className="">
                <div className="">
                    <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
                        <div className="flex items-center justify-center   ">
                            ...
                            <h1 className="text-3xl font-bold mr-2 text-black ">
                                الطلاب المشتركين في هذا المسار
                                {/* {students?.length > 0
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="flex items-center gap-2 text-gray-600 text-2xl">
                                                        ...
                                                        <a
                                                            // href={`mailto:${student?.whatsapp_number}`}
                                                            href={`https://wa.me/+2${student?.whatsapp_number}`}
                                                            className={`hover:text-blue-600 transition-all duration-300 truncate`}
                                                        >
                                                            {
                    ...
                    <div className="p-4 border-t border-gray-200 bg-gray-50 hidden">
