...
function QuranPathUpdate() {
    ...
    const handleUpdate = async (formData) => {
        try {
            ...
            const { data, error } = await publicUpdateQuranPath(
                quranpathId,
                updateData
            );
    ...
    const handleDelete = async () => {
        try {
            ...
            const { error } = await publicDeleteQuranPath(quranpathId);
                ...
                {showDeleteConfirm && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg max-w-md w-full">
                            ...
                            <p className="mb-6">
                                هل أنت متأكد من حذف هذا المسار؟ لا يمكن التراجع
                                عن هذا الإجراء.
                            </p>
                            <div className="flex justify-end gap-4">
                                <button
...
export default QuranPathUpdate;
