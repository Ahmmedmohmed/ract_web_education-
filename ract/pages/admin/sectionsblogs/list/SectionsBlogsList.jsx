...
import {
    ...
    adminUpdateSectionBlogVisibility,
    adminGetSectionsBlogsAdmin,
...
function SectionsBlogsList() {
    ...
    const handleVisibilityChange = async (sectionId, newVisibility) => {
        ...
        try {
            const { data, error } = await adminUpdateSectionBlogVisibility(
                sectionId,
                newVisibility
            );
    ...
    const confirmDelete = async () => {
        try {
            const { error } = await adminDeleteSectionBlog(
        ...
        <>
            <div className="space-y-6 bg-gray-50 min-h-screen">
                <div className="flex justify-between items-center flex-wrap mb-8">
                    ...
                    <button
                        onClick={() =>
                            navigate(`/${App_Admin}/sectionsblogs/create`)
                        }
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center justify-end gap-3">
                                                        ...
                                                        <Link
                                                            to={`/${App_Admin}/sectionsblogs/update/${section?.id}`}
...
export default SectionsBlogsList;
