...
function SectionsBlogsCreate() {
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            const { data, error } = await adminCreateSectionBlog(sectionData);
...
export default SectionsBlogsCreate;
