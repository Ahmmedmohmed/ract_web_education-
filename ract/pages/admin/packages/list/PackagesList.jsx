        ...
        <>
            <div className="space-y-6">
                <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
                    ...
                    <Link
                        to={`/${App_Admin}/packages/discount`}
                            ...
                            {courses?.map((course, index) => (
                                ...
                                >
                                    <div className="flex flex-col md:flex-row p-4">
                                        <div
                                            className="w-full md:min-w-60 md:max-w-60 h-60 md:h-60   overflow-hidden rounded-lg md:ml-4 mb-4 md:mb-0 cursor-pointer border border-gray-300 shadow-md"
                                            onClick={() => {
                                                // if (
                                                //     userData?.id ===
                                                //     course?.user?.id
                                        ...
                                        >
                                            <img
                                                ...
                                                loading="lazy"
                                                className="w-full h-full object-fill md:max-h-60"
                                            />
                                        </div>
                                            ...
                                            <div className="flex justify-between items-start">
                                                ...
                                                <div className="flex space-x-2">
                                                    ...
                                                    {userData?.id ===
                                                        course?.user?.id && (
                                                        <Link
                                                            to={`/${App_Admin}/packages/update/${course?.id}`}
                                                            className={`p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md`}
                                                            title="تعديل الباقة"
                                                        >
                                                            <Edit size={18} />
