...
import { publicCreateBook } from "../../../../api/public/authPublic";
...
function BooksCreate() {
    ...
    // console.log(`uploadedFile`, uploadedFilePDF);
    ...
    const handleCourseSubmit = async (formData) => {
        try {
            ...
            if (uploadedFilePDF) courseData.append("file_pdf", uploadedFilePDF);
            ...
            const { data, error } = await publicCreateBook(courseData);
