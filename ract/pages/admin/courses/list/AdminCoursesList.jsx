...
function AdminCoursesList() {
    ...
    const fetchCourses = async () => {
        try {
            ...
            const { data, error } = await publicGetCourses(currentPage);
