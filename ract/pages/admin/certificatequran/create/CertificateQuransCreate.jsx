...
// api
import { publicCreateCertificateQuran } from "../../../../api/public/authPublic";
...
function CertificateQuransCreate() {
    const { quranpathId, chapterinquranId, studentId } = useParams();
    ...
    const handleSectionSubmit = async (formData) => {
        try {
            ...
            sectionData.append("student", studentId || null);
            ...
            const { data, error } = await publicCreateCertificateQuran(
                sectionData
            );
...
export default CertificateQuransCreate;
