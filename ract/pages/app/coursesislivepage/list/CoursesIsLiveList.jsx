...
import CourseIsLiveCard from "../card/CourseIsLiveCard";
...
function CoursesIsLiveList() {
    ...
    const fetchCourses = async () => {
        try {
            ...
            const { data, error } = await appGetCoursesIsLive(
                currentPage,
                selectedStatus
            );
...
export default CoursesIsLiveList;
