...
import { ArrowRight, Check, Eye, EyeOff, MessageSquare } from "lucide-react";

// styles
// import "./Contact.scss";

// api
import { appCreateContactMessage } from "../../../api/app/authApp";
...
function Contact() {
    ...
    const handleContactSubmit = async (formData) => {
        try {
            ...
            // if (userData?.id) contactData.append("user", userData?.id || null);
            // console.log(`contactData`, contactData);

            const { data, error } = await appCreateContactMessage(contactData);
    ...
    return (
        <>
            <div className="conatct-us py-60 pb-60" id="contactUs">
                <div className="container relative mx-auto  px-4 py-8">
                    <div className="flex items-center justify-center mb-6">
                        ...
                        <h1 className="text-4xl font-bold mr-2 text-black">
                            تواصل معنا
                        </h1>
                    </div>
                    ...
                    <div className="box flex flex-col md:flex-row items-center justify-between gap-12">
                        <div
                            className="flex-1 p-6 my-8 w-full"
                            data-aos="fade-left"
                        >
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`text-2xl text-black w-full p-2 border border-gray-300 rounded-md focus:ring-1 focus:border-blue-500 outline-0`}
                                        {...register("full_name", {
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className={`text-2xl text-black w-full min-h-40 p-2 border border-gray-300 rounded-md focus:ring-1 outline-0 focus:border-blue-500 resize-none`}
                                        {...register("message", {
                                            required: "هذا الحقل مطلوب.",
                                            minLength: {
                                                value: 10,
