...
function QuestionsBanksList() {
    ...
    useEffect(() => {
        const fetchQuestionsBanks = async () => {
            try {
                ...
                const { data, error } = await appGetQuestionsBanksApp(
                    currentPage,
                    selectedStatus
                );
    ...
    // console.log(`questionsBanks`, questionsBanks);
            ...
            >
                <div className="container mx-auto">
                    <div className="py-20">
                        ...
                        <h1 className="h2 section-title" data-aos="fade-down">
                            {`
